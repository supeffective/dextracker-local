const data = {
  ...
  WEBAPP_NAME_SHORT: 'SuperPokédexTracker',
  WEBAPP_TITLE: 'Super Pokédex Tracker - Track the progress of any Pokémon game',
  WEBAPP_THEME_COLOR: '#1C7ED6',
  WEBAPP_DESCRIPTION:
  ...
  patreon_url: 'https://www.patreon.com/supereffective',
  discord_url: 'https://discord.gg/3fRXQFtrkN',
