import discordIcon from '@/assets/brands/discord-icon.svg'
import githubIcon from '@/assets/brands/github-icon.svg'
import patreonIcon from '@/assets/brands/patreon-icon.svg'
